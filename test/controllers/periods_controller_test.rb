...
class PeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post periods_url, params: { period: { description: @period.description, final_date: @period.final_date, initial_date: @period.initial_date } }, as: :json
    end
  ...
  test "should update period" do
    patch period_url(@period), params: { period: { description: @period.description, final_date: @period.final_date, initial_date: @period.initial_date } }, as: :json
    assert_response 200
  end
